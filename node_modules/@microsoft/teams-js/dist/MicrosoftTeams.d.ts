...
declare namespace microsoftTeams {
  ...
  export namespace teams {
       ...
       */
      function refreshSiteUrl(callback: (error: SdkError) => void, threadId?: string): void;
  }
  ...
  export namespace media {
      ...
      interface VideoProps extends MediaProps {
          ...
          /**
           * Optional; contolls the visibility of pause button in PictureInPicture Mode.
           * Default value is true, indicating the user will be able to pause the video.
           */
          isPauseButtonVisible?: boolean;
          /**
           * Optional; contolls the visibility of stop button in PictureInPicture Mode.
           * Default value is true, indicating the user will be able to stop the video.
           */
          isStopButtonVisible?: boolean;
          /**
           * Optional; setting VideoController will register your app to listen to lifecycle events during the video capture flow.
           * Your app can also control the experience while capturing the video by notifying the client about VideoControllerEvent.
           */
      ...
      interface AudioProps {
          ...
          maxDuration?: number;
          /**
           * Optional; setting AudioController will register your app to listen to lifecycle events during the audio recording flow.
           * Your app can also control the experience while recording the audio by notifying the client about AudioControllerEvent.
           */
       ...
       */
      enum MediaNotificationEventFromClient {
          PreviewStart = 1,
          RecordingStart = 2,
          RecordingPause = 3,
          RecordingResume = 4
       ...
       */
      abstract class MediaController<T, K> {
          protected callback: K;
          constructor(callback: K);
          protected abstract getMediaType(): MediaType;
          protected abstract resolveEvent(mediaEvent: T): void;
          notifyEvent(mediaEvent: T): void;
      }
      /**
       *  Events which are signaled by the app to the client to control the experience while capturing the video
       */
      enum VideoControllerEvent {
          RecordingPause = 1,
          RecordingResume = 2,
          RecordingStop = 3,
          PictureInPictureMode = 4
      }
      /**
       ...
       */
      class VideoController extends MediaController<VideoControllerEvent, VideoControllerCallback> {
          protected getMediaType(): MediaType;
          resolveEvent(mediaEvent: VideoControllerEvent | MediaNotificationEventFromClient): void;
      }
      /**
       ...
       */
      interface AudioControllerCallback {
          onRecordingStart(): void;
          onRecordingPause(): void;
          onRecordingResume(): void;
      }
       ...
       */
      class AudioController extends MediaController<AudioControllerEvent, AudioControllerCallback> {
          protected getMediaType(): MediaType;
          resolveEvent(mediaEvent: AudioControllerEvent | MediaNotificationEventFromClient): void;
      }
      /**
  ...
  export namespace sharing {
      ...
      type IShareRequestContentType = IURLContent;
      interface IShareRequest<T> {
          content: T[];
      }
      interface IURLContent extends IBaseSharedContent {
          type: 'URL';
          /**
           * Required URL
           */
       ...
       */
      function shareWebContent(shareWebContentRequest: IShareRequest<IShareRequestContentType>, callback?: (err?: SdkError) => void): void;
  }
  /**
