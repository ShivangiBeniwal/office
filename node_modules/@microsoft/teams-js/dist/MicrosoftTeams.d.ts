...
declare namespace microsoftTeams {
  ...
  export namespace media {
       ...
       */
      class VideoController extends MediaController<VideoControllerCallback> {
          protected getMediaType(): MediaType;
          pauseVideo(callback?: (err?: SdkError) => void): void;
          resumeVideo(callback?: (err?: SdkError) => void): void;
          stopVideo(callback?: (err?: SdkError) => void): void;
       ...
       */
      class AudioController extends MediaController<AudioControllerCallback> {
          protected getMediaType(): MediaType;
          pauseAudio(callback?: (err?: SdkError) => void): void;
          resumeAudio(callback?: (err?: SdkError) => void): void;
          stopAudio(callback?: (err?: SdkError) => void): void;
          notifyEventToApp(mediaEvent: MediaControllerEvent): void;
      }
      /**
