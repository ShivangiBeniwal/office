...
declare namespace microsoftTeams {
  ...
  export namespace files {
       ...
       */
      interface IExternalProvider extends IWopiService {
       ...
       */
      enum SpecialDocumentLibraryType {
       ...
       */
      enum DocumentLibraryAccessType {
          Readonly = "readonly"
      }
      /**
       * @private
       ...
       */
      function getExternalProviders(excludeAddedProviders: boolean, callback: (error: SdkError, providers: IExternalProvider[]) => void): void;
      /**
       * @private
       * Allow 1st party apps to call this function to move files
       * among SharePoint and third party cloud storages.
       */
      function copyMoveFiles(selectedFiles: CloudStorageFolderItem[] | ISharePointFile[], providerCode: CloudStorageProvider, destinationFolder: CloudStorageFolderItem | ISharePointFile, destinationProviderCode: CloudStorageProvider, isMove: boolean, callback: (error?: SdkError) => void): void;
  }
  /**
   * @private
   * Hide from docs
