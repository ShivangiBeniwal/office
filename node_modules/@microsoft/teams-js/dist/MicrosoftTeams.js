...
(function (media) {
     ...
     * Hide from docs
     * --------
     * Events which are signaled by the client to the app
     */
    var MediaNotificationEventFromClient;
    (function (MediaNotificationEventFromClient) {
        MediaNotificationEventFromClient[MediaNotificationEventFromClient["PreviewStart"] = 1] = "PreviewStart";
        MediaNotificationEventFromClient[MediaNotificationEventFromClient["RecordingStart"] = 2] = "RecordingStart";
        MediaNotificationEventFromClient[MediaNotificationEventFromClient["RecordingPause"] = 3] = "RecordingPause";
        MediaNotificationEventFromClient[MediaNotificationEventFromClient["RecordingResume"] = 4] = "RecordingResume";
    })(MediaNotificationEventFromClient || (MediaNotificationEventFromClient = {}));
    /**
     * @private
     * Hide from docs
     * --------
     * Base class which holds the callback and notifies events to the client
     */
    var MediaController = /** @class */ (function () {
        function MediaController(callback) {
            this.callback = callback;
        }
        MediaController.prototype.notifyEvent = function (mediaEvent) {
            var _this = this;
            var params = { MediaType: this.getMediaType(), ControllerEvent: mediaEvent };
            communication_1.sendMessageToParent('mediaController', [params], function () {
                _this.resolveEvent(mediaEvent);
            });
        };
        return MediaController;
    }());
    /**
     *  Events which are signaled by the app to the client to control the experience while capturing the video
     */
    var VideoControllerEvent;
    (function (VideoControllerEvent) {
        VideoControllerEvent[VideoControllerEvent["RecordingPause"] = 1] = "RecordingPause";
        VideoControllerEvent[VideoControllerEvent["RecordingResume"] = 2] = "RecordingResume";
        VideoControllerEvent[VideoControllerEvent["RecordingStop"] = 3] = "RecordingStop";
        VideoControllerEvent[VideoControllerEvent["PictureInPictureMode"] = 4] = "PictureInPictureMode";
    })(VideoControllerEvent = media.VideoControllerEvent || (media.VideoControllerEvent = {}));
    /**
     * VideoController class is used to communicate between the app and the client during the video capture flow
     */
    var VideoController = /** @class */ (function (_super) {
        ...
        VideoController.prototype.resolveEvent = function (mediaEvent) {
            switch (mediaEvent) {
                case MediaNotificationEventFromClient.RecordingStart:
                    this.callback.onRecordingStart();
                    break;
                case MediaNotificationEventFromClient.RecordingPause:
                case VideoControllerEvent.RecordingPause:
                    this.callback.onRecordingPause();
                    break;
                case MediaNotificationEventFromClient.RecordingResume:
                case VideoControllerEvent.RecordingResume:
                    this.callback.onRecordingResume();
                    break;
                case MediaNotificationEventFromClient.PreviewStart:
                    this.callback.onPreviewStart();
                    break;
                case VideoControllerEvent.PictureInPictureMode:
                    this.callback.onPictureInPictureMode();
            }
        };
    ...
    /**
     *  Events which are signaled by the app to the client to control the experience while recording the audio
     */
    var AudioControllerEvent;
    (function (AudioControllerEvent) {
        AudioControllerEvent[AudioControllerEvent["RecordingPause"] = 1] = "RecordingPause";
        AudioControllerEvent[AudioControllerEvent["RecordingResume"] = 2] = "RecordingResume";
        AudioControllerEvent[AudioControllerEvent["RecordingStop"] = 3] = "RecordingStop";
    })(AudioControllerEvent = media.AudioControllerEvent || (media.AudioControllerEvent = {}));
    /**
     * AudioController class is used to communicate between the app and the client during the audio recording flow
     */
    var AudioController = /** @class */ (function (_super) {
        ...
        AudioController.prototype.getMediaType = function () {
            return MediaType.Audio;
        };
        AudioController.prototype.resolveEvent = function (mediaEvent) {
            switch (mediaEvent) {
                case MediaNotificationEventFromClient.RecordingStart:
                    this.callback.onRecordingStart();
                    break;
                case MediaNotificationEventFromClient.RecordingPause:
                case AudioControllerEvent.RecordingPause:
                    this.callback.onRecordingPause();
                    break;
                case MediaNotificationEventFromClient.RecordingResume:
                case AudioControllerEvent.RecordingResume:
                    this.callback.onRecordingResume();
                    break;
            }
        };
    ...
    media.AudioController = AudioController;
    /**
    ...
    function selectMedia(mediaInputs, callback) {
        ...
        communication_1.sendMessageToParent('selectMedia', params, function (err, localAttachments, mediaEvent) {
            ...
            if (mediaEvent) {
                if (mediaInputs.mediaType == 2 && mediaInputs.videoProps && mediaInputs.videoProps.videoController) {
                    mediaInputs.videoProps.videoController.resolveEvent(mediaEvent);
                }
                else if (mediaInputs.mediaType == 4 && mediaInputs.audioProps && mediaInputs.audioProps.audioController) {
                    mediaInputs.audioProps.audioController.resolveEvent(mediaEvent);
                }
                return;
            }
