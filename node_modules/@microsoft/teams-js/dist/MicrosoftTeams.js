...
(function (media) {
    ...
    var MediaController = /** @class */ (function () {
        ...
        MediaController.prototype.notifyEventToHost = function (mediaEvent, callback) {
            internalAPIs_1.ensureInitialized(constants_1.FrameContexts.content, constants_1.FrameContexts.task);
            var err = internalAPIs_1.isApiSupportedOnMobile(constants_2.nonFullScreenVideoModeAPISupportVersion);
            if (err) {
                if (callback) {
                    callback(err);
                }
            ...
            communication_1.sendMessageToParent('media.controller', [params], function (err) {
                if (callback) {
                    callback(err);
                }
            });
    ...
    function selectMedia(mediaInputs, callback) {
        ...
        var err = mediaUtil_1.isMediaCallSupportedOnMobile(mediaInputs);
        if (err) {
            callback(err, null);
            return;
        }
...
function isMediaCallSupportedOnMobile(mediaInputs) {
    if (isMediaCallForVideoAndImageInputs(mediaInputs)) {
        return internalAPIs_1.isApiSupportedOnMobile(constants_1.videoAndImageMediaAPISupportVersion);
    }
    else if (isMediaCallForNonFullScreenVideoMode(mediaInputs)) {
        return internalAPIs_1.isApiSupportedOnMobile(constants_1.nonFullScreenVideoModeAPISupportVersion);
    }
    return null;
}
...
(function (files) {
    ...
    function getExternalProviders(excludeAddedProviders, callback) {
        ...
        communication_1.sendMessageToParent('files.getExternalProviders', [excludeAddedProviders], callback);
    }
    ...
    function copyMoveFiles(selectedFiles, providerCode, destinationFolder, destinationProviderCode, isMove, callback) {
        ...
        communication_1.sendMessageToParent('files.copyMoveFiles', [selectedFiles, providerCode, destinationFolder, destinationProviderCode, isMove], callback);
    }
...
(function (appEntity_1) {
    ...
    function selectAppEntity(threadId, categories, subEntityId, callback) {
        ...
        communication_1.sendMessageToParent('appEntity.selectAppEntity', [threadId, categories, subEntityId], callback);
    }
