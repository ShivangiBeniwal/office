...
(function (media) {
    ...
    (function (MediaControllerEvent) {
        MediaControllerEvent[MediaControllerEvent["PreviewStart"] = 1] = "PreviewStart";
        MediaControllerEvent[MediaControllerEvent["RecordingStart"] = 2] = "RecordingStart";
        MediaControllerEvent[MediaControllerEvent["RecordingPause"] = 3] = "RecordingPause";
        MediaControllerEvent[MediaControllerEvent["RecordingResume"] = 4] = "RecordingResume";
        MediaControllerEvent[MediaControllerEvent["RecordingStop"] = 5] = "RecordingStop";
    ...
    var MediaController = /** @class */ (function () {
         ...
         * Optional; @param callback is used to send app if platform client has successfully handled the notification event or not
         */
        MediaController.prototype.notifyEventToClient = function (mediaEvent, callback) {
    ...
    var VideoController = /** @class */ (function (_super) {
        ...
        VideoController.prototype.pauseVideo = function (callback) {
            this.notifyEventToClient(MediaControllerEvent.RecordingPause, callback);
        };
        VideoController.prototype.resumeVideo = function (callback) {
            this.notifyEventToClient(MediaControllerEvent.RecordingResume, callback);
        };
        VideoController.prototype.stopVideo = function (callback) {
    ...
    var AudioController = /** @class */ (function (_super) {
        ...
        AudioController.prototype.pauseAudio = function (callback) {
            this.notifyEventToClient(MediaControllerEvent.RecordingPause, callback);
        };
        AudioController.prototype.resumeAudio = function (callback) {
            this.notifyEventToClient(MediaControllerEvent.RecordingResume, callback);
        };
        AudioController.prototype.stopAudio = function (callback) {
            this.notifyEventToClient(MediaControllerEvent.RecordingStop, callback);
        };
        AudioController.prototype.notifyEventToApp = function (mediaEvent) {
            if (!this.controllerCallback) {
                // Early return as app has not registered with the callback
                return;
            }
